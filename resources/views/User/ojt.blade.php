                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="form_fullname" type="text" name="fullname" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="form_school" type="text" name="school" class="form-control"
                                           placeholder="Please enter your school/university *" required="required"
                                           data-error="School/university is required.">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="form_ojt_hours" type="text" name="ojt_hours" class="form-control"
                                           placeholder="Please enter your OJT hours *" required="required"
                                           data-error="OJT hours are required.">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="form_resume" type="file" name="resume" class="form-control-file"
                                           required="required" data-error="Please upload your resume.">
                                </div>
                            </div>
                        </div>
